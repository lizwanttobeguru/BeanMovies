    ...
    <view class="bgffff position-relative  width-000 " style="top: -30rpx; border-radius: 10rpx 10rpx 0 0;">
      ...
      <view class="px-2 mt-4" v-if="historySearchArr.length > 0">
        <view class="d-flex a-center j-sb">
          ...
          <view @tap="delHistorySearch"
            class="d-flex a-center j-center iconfont icondelete color-hui font-27 width-50 height-50">
      ...
      <view class="px-2 mt-4">
        <view class="d-flex a-center j-sb">
          ...
          <view @tap="isShowHot" :class="isShowHotData?'iconyanjing':'iconkanguo'"
            class="d-flex a-center j-center iconfont  color-hui font-27 width-50 height-50">
