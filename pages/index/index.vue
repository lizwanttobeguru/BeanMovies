<template>
  <view class="">
    ...
    <view class="width-000 ">
      <commonTitle :defaultSty="false" :isShowIcon="false" :center="true"></commonTitle>
    </view>
    <!-- 导航栏 -->
      ...
      <view class="d-flex a-center width-000 height-000">
        ...
        <view class="width-000 height-50 d-flex a-center">
          <swiper indicator-active-color="white" :vertical="true" autoplay circular class="swiper width-000 height-50"
            style="line-height: 50rpx;" :indicator-dots="configCarousel.indicatorDots"
            :autoplay="configCarousel.autoplay || true" :interval="configCarousel.interval || 2000"
